...
export const FRONTEND_HANDBOOKS = [
  ...
  { id: "frontend-rendering", label: "03 번들링·렌더링·메모이제이션", kind: "프론트엔드 핸드북", file: "frontend-rendering-optimization-handbook.html" },
  { id: "frontend-performance", label: "04 성능과 지표", kind: "프론트엔드 핸드북", file: "frontend-performance-metrics-handbook.html" },
  { id: "frontend-devtools", label: "05 DevTools 사용법", kind: "프론트엔드 핸드북", file: "frontend-devtools-handbook.html" },
